...
export default function PricingPage() {
  ...
  const balance = customer?.balances?.["repurposes"];
      ...
      <div className="p-8">
        <div className="mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: "var(--text-secondary)" }}>
            {balance && `You have ${balance.remaining} / ${balance.granted} repurposes left this month.`}
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                {isActive ? (
                  ...
                  <button
                    onClick={() => attach({ planId: plan.id, successUrl: window.location.origin + "/dashboard" })}
